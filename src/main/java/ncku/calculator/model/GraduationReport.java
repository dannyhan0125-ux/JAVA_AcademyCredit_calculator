...
public class GraduationReport {
        ...
        public Map<CreditCategory, Double> getCreditsByCategory() {
                return creditsByCategory;
        }

        public Map<CreditCategory, Integer> getCountsByCategory() {
                return countsByCategory;
        }

        public double getGeneralTotalCredits() {
                return generalTotalCredits;
        }

        public int getGeneralCategoryCount() {
                return generalCategoryCount;
        }

        public double getOutsideTotalCredits() {
                return outsideTotalCredits;
        }
        ...
        private void appendCreditRow(StringBuilder sb, String label, double completed, int required) {
                ...
                sb.append(String.format("  %-14s：%s / %d 學分  %s%n",
                                ...
                                met ? "已達標"
                                                : String.format("[X] 尚缺 %s", formatCredits(required - completed))));
        }
        ...
        private void appendCountRow(StringBuilder sb, String label, int completed, int required) {
                ...
                sb.append(String.format("  %-14s：%d / %d 次  %s%n",
                                ...
                                met ? "已達標"
                                                : String.format("[X] 尚缺 %d 次", required - completed)));
        }
}
